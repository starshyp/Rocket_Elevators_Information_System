...
class BuildingDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building_detail" do
    assert_difference('BuildingDetail.count') do
      post building_details_url, params: { building_detail: { InformationKey: @building_detail.InformationKey, Value: @building_detail.Value } }
    end
  ...
  test "should update building_detail" do
    patch building_detail_url(@building_detail), params: { building_detail: { InformationKey: @building_detail.InformationKey, Value: @building_detail.Value } }
