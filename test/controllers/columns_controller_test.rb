...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { ColumnType: @column.ColumnType, Info: @column.Info, NbOfFloorsServed: @column.NbOfFloorsServed, Notes: @column.Notes, Status: @column.Status } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { ColumnType: @column.ColumnType, Info: @column.Info, NbOfFloorsServed: @column.NbOfFloorsServed, Notes: @column.Notes, Status: @column.Status } }
