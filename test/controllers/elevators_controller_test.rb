...
class ElevatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elevator" do
    assert_difference('Elevator.count') do
      post elevators_url, params: { elevator: { CertificateOfInspection: @elevator.CertificateOfInspection, DateOfCommissioning: @elevator.DateOfCommissioning, DateOfLastInspection: @elevator.DateOfLastInspection, ElevatorType: @elevator.ElevatorType, Info: @elevator.Info, Model: @elevator.Model, Notes: @elevator.Notes, SerialNumber: @elevator.SerialNumber, Status: @elevator.Status } }
    end
  ...
  test "should update elevator" do
    patch elevator_url(@elevator), params: { elevator: { CertificateOfInspection: @elevator.CertificateOfInspection, DateOfCommissioning: @elevator.DateOfCommissioning, DateOfLastInspection: @elevator.DateOfLastInspection, ElevatorType: @elevator.ElevatorType, Info: @elevator.Info, Model: @elevator.Model, Notes: @elevator.Notes, SerialNumber: @elevator.SerialNumber, Status: @elevator.Status } }
